...
wait()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999, 100, 999999)
...
for i,v in pairs(game.Players.LocalPlayer.Character.Head.face:GetChildren()) do
